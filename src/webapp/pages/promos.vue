              ...
              <div class="content">
                ...
                <p>
                  <small
                    ...
                    code will add robux to your RbxWallet account</small
                  >
                </p>
                <h6 class="card-title mb-4">
                ...
                <p>
                  <small
                    ...
                    robux will be automatically added to your RbxWallet account. Remember that promo codes may expire or
                ...
                <form class="card-form field is-grouped mt-5 mb-4 pt-3">
                  <div class="custom-floating-input control is-expanded">
                    ...
                    <label for="code-input">Enter a valid RbxWallet R$ Code!</label>
