    ...
    <nav class="navbar px-5 is-flex is-align-items-center" style="height: 85px;" role="navigation" aria-label="main navigation">
      ...
      <div class="navbar-menu is-hidden-touch">
        <div class="is-flex mx-auto">
          <nuxt-link to="/earn" class="navbar-item is-active is-flex is-align-items-center is-capitalized">
            <i class="fa fa-home mr-4 is-size-4" />
            <span class="is-active__text has-text-weight-bold">earn robux</span>
          </nuxt-link>
          <nuxt-link to="/withdraw" class="navbar-item custom-link is-flex is-align-items-center is-capitalized">
            <i class="fa fa-money mr-4 is-size-4" aria-hidden="true" />
            <span class="custom-link__text has-text-weight-bold">Withdraw</span>
          </nuxt-link>
          <nuxt-link to="/invites" class="navbar-item custom-link is-flex is-align-items-center is-capitalized">
          ...
          <nuxt-link to="/promos" class="navbar-item custom-link is-flex is-align-items-center is-capitalized">
            <i class="fas fa-user mr-4 is-size-4" aria-hidden="true" />
            <span class="custom-link__text has-text-weight-bold">promo code</span>
          </nuxt-link>
          <nuxt-link to="/help" class="navbar-item custom-link is-flex is-align-items-center is-capitalized">
